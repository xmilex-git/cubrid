...
typedef enum
{
  ...
  PSTAT_RAWFD_READ_CACHE_HIT,
  PSTAT_RAWFD_READ_CACHE_MISS,
  PSTAT_RAWFD_DECRYPT_COUNT,
  PSTAT_RAWFD_PLAINTEXT_WRITE_COUNT,
  PSTAT_RAWFD_PGBUF_SPILL_OVERFLOW,
  PSTAT_RAWFD_CREATE_FAILURE,
  PSTAT_RAWFD_ALLOC_CALLS,
  PSTAT_RAWFD_ALLOC_RETRY,
