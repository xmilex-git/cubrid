...
#define PRM_NAME_STREAMING_HASH_JOIN "streaming_hash_join"

#define PRM_NAME_HASH_JOIN_FUSED_PROBE "hash_join_fused_probe"
...
#define PRM_NAME_HEAP_INDEX_LOOKUP_FAST "heap_index_lookup_fast"
...
SYSPRM_PARAM prm_Def[] = {
  ...
  {PRM_ID_HASH_JOIN_FUSED_PROBE,
   PRM_NAME_HASH_JOIN_FUSED_PROBE,
   (PRM_USER_CHANGE | PRM_FOR_CLIENT | PRM_FOR_SERVER | PRM_FOR_SESSION | PRM_FOR_QRY_STRING),
   PRM_BOOLEAN,
   PRM_CLEAR_DYNAMIC_FLAG,
   {false, {.b = false}},
  ...
  {PRM_ID_QFILE_TUPLE_ENCODE_FAST,
   ...
   (DUP_PRM_FUNC) NULL,
   (DUP_PRM_FUNC) NULL},
  {PRM_ID_HEAP_INDEX_LOOKUP_FAST,
   PRM_NAME_HEAP_INDEX_LOOKUP_FAST,
   (PRM_USER_CHANGE | PRM_FOR_SERVER),
   PRM_BOOLEAN,
   PRM_CLEAR_DYNAMIC_FLAG,
   {false, {.b = false}},
