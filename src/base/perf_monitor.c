...
PSTAT_METADATA pstat_Metadata[] = {
  ...
  PSTAT_METADATA_INIT_SINGLE_PEEK (PSTAT_QF_NEW_BACKED_CREATE, "Num_qfile_tapeset_create"),
  PSTAT_METADATA_INIT_SINGLE_PEEK (PSTAT_QF_OLD_TOUCH_ON_NEW, "Num_qfile_pgbuf_touch_on_tapeset"),
