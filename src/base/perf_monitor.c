...
PSTAT_METADATA pstat_Metadata[] = {
  ...
  PSTAT_METADATA_INIT_SINGLE_ACC (PSTAT_QM_NUM_DOMAIN_RESOLVE_FETCH, "Num_domain_resolve_fetch"),
  PSTAT_METADATA_INIT_SINGLE_ACC (PSTAT_QM_NUM_DOMAIN_COERCE_COMPARE, "Num_domain_coerce_compare"),
  PSTAT_METADATA_INIT_SINGLE_ACC (PSTAT_QM_NUM_DOMAIN_RESOLVE_LIST, "Num_domain_resolve_list"),
  PSTAT_METADATA_INIT_SINGLE_ACC (PSTAT_QM_NUM_DOMAIN_RESOLVE_AGG, "Num_domain_resolve_agg"),
  PSTAT_METADATA_INIT_SINGLE_ACC (PSTAT_QM_NUM_DOMAIN_KEY_COERCE, "Num_domain_key_coerce"),
