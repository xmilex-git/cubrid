...
pt_make_query_show_exec_stats_all (PARSER_CONTEXT * parser)
{
  ...
  const char *query =
    ...
    "UNION ALL (SELECT 'domain_resolve_fetch' as [variable] , exec_stats('Num_domain_resolve_fetch') as [value])"
    "UNION ALL (SELECT 'domain_coerce_compare' as [variable] , exec_stats('Num_domain_coerce_compare') as [value])"
    "UNION ALL (SELECT 'domain_resolve_list' as [variable] , exec_stats('Num_domain_resolve_list') as [value])"
    "UNION ALL (SELECT 'domain_resolve_agg' as [variable] , exec_stats('Num_domain_resolve_agg') as [value])"
    "UNION ALL (SELECT 'domain_key_coerce' as [variable] , exec_stats('Num_domain_key_coerce') as [value])"
