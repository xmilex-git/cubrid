...
extern SCAN_CODE heap_get_visible_version_lookup_fast (THREAD_ENTRY * thread_p, const OID * oid, const OID * next_oid,
						       RECDES * recdes, HEAP_SCANCACHE * scan_cache, bool * handled);
